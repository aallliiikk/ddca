...
HD_PWD='/home/nimbes/ddca/dimmedLed/dimmedLed.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dimmedLed.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dimmedLed.tcl -notrace
