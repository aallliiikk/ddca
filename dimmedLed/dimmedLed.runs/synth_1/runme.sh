...
HD_PWD='/home/nimbes/ddca/dimmedLed/dimmedLed.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dimmedLed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dimmedLed.tcl
