...
HD_PWD='/home/alik/repos/DDCA/lab_6_testbench/lab_6_testbench.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder32.tcl -notrace
