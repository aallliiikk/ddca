...
HD_PWD='/home/alik/repos/DDCA/lab_6_testbench/lab_6_testbench.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder32.tcl
