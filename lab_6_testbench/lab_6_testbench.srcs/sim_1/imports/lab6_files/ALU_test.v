...
module ALU_test();
    ...
    begin
        ...
        $readmemh("/home/alik/lab_6_testbench/lab_6_testbench.sim/sim_1/behav/xsim/testvectors_hex.txt", testvec);
    ...
    Alu ourAlu(a, b, aluop, result, zero);
endmodule
